			...
			<div class="col-sm-12 col-md-12 col-lg-8">
				<div class="col-sm-12 col-md-12 col-lg-12">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control form-control-lg border-secondary" id="nombre" aria-describedby="emailHelp" placeholder="Ingresar Nombre">
					</div>

					<div class="form-group">
						<label class="text-secondary col-form-label-md" for="email">Correo:</label>
						<input type="email" class="form-control form-control-lg border-secondary" id="email" aria-describedby="emailHelp" placeholder="Ingresar Correo">
					</div>

					<div class="form-group">
						<label class="text-secondary col-form-label-md border-dark" for="contenido">Mensaje</label>
						<textarea class="form-control border-secondary" id="mensaje" rows="3" placeholder="Escribir mensaje"></textarea>
					</div>

					<button type="submit" class="btn btn-block btn-outline-secondary mb-5">Enviar Mensaje</button>
				</form>
				</div>
			</div>
